...
-- Keybinds for system clipboard
vim.keymap.set('n', 'Y', '"+y', { desc = 'Copy to system clipboard' })
vim.keymap.set('n', 'D', '"+d', { desc = 'Delete and copy to system clipboard' })
vim.keymap.set('n', '<C-p>', '"+p', { desc = 'Paste after from system clipboard' })
vim.keymap.set('n', '<C-P>', '"+P', { desc = 'Paste before from system clipboard' })
